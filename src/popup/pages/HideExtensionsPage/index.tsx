...
interface HideExtensionsPageProps {
  tab: string
}

const HideExtensionsPage = ({ tab }: HideExtensionsPageProps) => {
  ...
  return (
    <Page isCurrentTab={tab === 'hide'} title={'Hide Settings'}>
      <Checkbox
        title="Enable Proxy"
...
export default HideExtensionsPage;
